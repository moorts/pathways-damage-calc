...
const PATHWAYS_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  'Glimmora-Mega': {
    types: ['Rock', 'Poison'],
    bs: { hp: 83, at: 75, df: 110, sa: 145, sd: 106, sp: 106 },
    abilities: {0: 'Stellar Debris'},
    baseSpecies: 'Glimmora',
  },
  Froslass: { otherFormes: ['Froslass-Mega'] },
  'Froslass-Mega': {
    types: ['Ghost', 'Ice'],
    bs: { hp: 70, at: 120, df: 75, sa: 120, sd: 75, sp: 120 },
    abilities: {0: 'Ghouliate'},
    baseSpecies: 'Froslass',
  },
  Goodra: { otherFormes: ['Goodra-Mega'] },
  'Goodra-Mega': {
    types: ['Dragon', 'Poison'],
    bs: { hp: 90, at: 140, df: 70, sa: 150, sd: 170, sp: 80 },
    abilities: {0: 'Gooey'},
    baseSpecies: 'Goodra',
  },
  Shedinja: { otherFormes: ['Shedinja-Mega'] },
  'Shedinja-Mega': {
    types: ['Bug', 'Ghost'],
    bs: { hp: 1, at: 172, df: 1, sa: 1, sd: 1, sp: 160 },
    abilities: {0: 'Magic Guard'},
  ...
  'Baxcalibur-Mega': {
    types: ['Dragon', 'Ice'],
    bs: { hp: 115, at: 165, df: 102, sa: 120, sd: 101, sp: 97 },
    abilities: {0: 'Thermal Exchange'},
    baseSpecies: 'Baxcalibur',
  },
  Swanna: { otherFormes: ['Swanna-Mega'] },
  'Swanna-Mega': {
    types: ['Water', 'Flying'],
    bs: { hp: 75, at: 130, df: 60, sa: 130, sd: 60, sp: 118 },
    abilities: {0: 'Technician'},
    baseSpecies: 'Swanna',
  },
  ...
  'Tropius-Mega': {
    types: ['Grass', 'Flying'],
    bs: { hp: 99, at: 138, df: 103, sa: 42, sd: 107, sp: 71 },
    abilities: {0: 'Wind Rider'},
    baseSpecies: 'Tropius',
  },
  Vikavolt: { otherFormes: ['Vikavolt-Mega'] },
  'Vikavolt-Mega': {
    types: ['Bug', 'Electric'],
    bs: { hp: 77, at: 70, df: 150, sa: 175, sd: 115, sp: 13 },
    abilities: {0: 'No Guard'},
    baseSpecies: 'Vikavolt',
  },
  Electrode: { otherFormes: ['Electrode-Mega'] },
  'Electrode-Mega': {
    types: ['Electric', 'Steel'],
    bs: { hp: 60, at: 50, df: 90, sa: 120, sd: 90, sp: 180 },
    abilities: {0: 'Demolition Expert'},
    baseSpecies: 'Electrode',
  },
  Mismagius: { otherFormes: ['Mismagius-Mega'] },
  'Mismagius-Mega': {
    types: ['Ghost', 'Fire'],
    bs: { hp: 60, at: 75, df: 75, sa: 155, sd: 115, sp: 115 },
    abilities: {0: 'Witchcraft'},
    baseSpecies: 'Mismagius',
  },
  Krookodile: { otherFormes: ['Krookodile-Mega'] },
  'Krookodile-Mega': {
    types: ['Ground', 'Dark'],
    bs: { hp: 95, at: 130, df: 95, sa: 95, sd: 95, sp: 109 },
    abilities: {0: 'Moxie'},
